...
func Authorize(ctx *fasthttp.RequestCtx) {
	...
	case "POST":
		...
		user.AbstractUser.ShareEmailVer = string(ctx.FormValue("share_email_ver")) == "true"
		user.AbstractUser.SharePhoneNumberVer = string(ctx.FormValue("share_phone_number_ver")) == "true"
		user.AbstractUser.ShareAddressVer = string(ctx.FormValue("share_address_ver")) == "true"
		user.AbstractUser.ShareIdVer = string(ctx.FormValue("share_id_ver")) == "true"
		// update user
